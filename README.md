...
[💾 macOS Installer (PKG)](https://github.com/danielraffel/Griddy-MIDI-Effect-Plugin/releases/download/v1.0.26/Griddy_1.0.26.pkg)

[🪟 Windows Installer (EXE)](https://github.com/danielraffel/Griddy-MIDI-Effect-Plugin/releases/download/v1.0.26/Griddy_1.0.26_Setup.exe)
